Ext.define('GibsonOS.module.ftp.index.View', {
    extend: 'GibsonOS.View',
    alias: ['widget.gosModuleFtpIndexView'],
    requiredPermission: {
        module: 'ftp',
        task: 'index'
    },
    ...
    initComponent: function() {
        ...
        me.itemContextMenu = GibsonOS.module.ftp.index.contextMenu.item;
        me.containerContextMenu = GibsonOS.module.ftp.index.contextMenu.container;
        ...
        me.itemId = 'ftpIndexView' + iconSize;

        me.callParent();
        me.on('itemdblclick', GibsonOS.module.ftp.index.listener.itemDblClick);
        me.on('itemkeydown', function(view, record, item, index, event) {
            if (event.getKey() == Ext.EventObject.DELETE) {
                ...
                GibsonOS.module.ftp.index.fn.delete(dir, records, {
                ...
                GibsonOS.module.ftp.index.listener.itemDblClick(view, record);
            } else {
