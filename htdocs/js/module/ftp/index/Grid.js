Ext.define('GibsonOS.module.ftp.index.ContainerGrid', {
    extend: 'GibsonOS.grid.Panel',
    alias: ['widget.gosModuleFtpIndexContainerGrid'],
    itemId: 'ftpIndexGrid',
    requiredPermission: {
        module: 'ftp',
        task: 'index'
    ...
    initComponent: function() {
        ...
        this.itemContextMenu = GibsonOS.module.ftp.index.contextMenu.item;
        this.containerContextMenu = GibsonOS.module.ftp.index.contextMenu.container;

        this.callParent();

        this.on('itemdblclick', GibsonOS.module.ftp.index.listener.itemDblClick);
        this.on('cellkeydown', function(table, td, cellIndex, record, tr, rowIndex, event) {
            if (event.getKey() == Ext.EventObject.DELETE) {
                ...
                GibsonOS.module.ftp.index.listener.itemDblClick(grid, record);
            } else {
