Ext.define('GibsonOS.module.ftp.index.download.Button', {
    extend: 'Ext.menu.Item',
    alias: ['widget.gosModuleFtpIndexDownloadButton'],
    itemId: 'ftpIndexDownloadButton',
    text: 'Download',
    ...
    handler: function() {
        ...
        if (localPath) {
            ...
            GibsonOS.module.ftp.index.fn.download(dir, files, localPath, {
