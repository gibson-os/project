Ext.define('GibsonOS.module.ftp.index.transfer.Grid', {
    extend: 'GibsonOS.grid.Panel',
    alias: ['widget.gosModuleFtpIndexTransferGrid'],
    requiredPermission: {
        module: 'ftp',
        task: 'index'
    },
    ...
    initComponent: function() {
        ...
        this.store = new GibsonOS.module.ftp.index.store.Transfer({
            gos: {
                autoReload: true,
            ...
            listeners: {
                load: function(store, records, successful, operation, options) {
                    ...
                    var btnRefresh = grid.down('#ftpIndexTransferRefreshButton');
        ...
        this.dockedItems = [{
            ...
            items: [{
                xtype: 'gosButton',
                itemId: 'ftpIndexTransferRefreshButton',
                text: 'Refresh',
                enableToggle: true,
                listeners: {
